...
export const AdminPage = () => {
  ...
  const [playersValues, setPlayersValues] = useState<any>(
    initStreamData
      ? initStreamData.players.reduce(
          (acc: any, el: any) => ({
            ...acc,
            [el.id]: {
              name: el.name,
  ...
  const [players, setPlayers] = useState<{ id: string | number }[]>(
    initStreamData ? initStreamData.players.map((el: any) => ({ id: el.id })) : [{ id: initialId }]
  );
  const addPlayer = () => {
